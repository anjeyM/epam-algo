...
export function pipe<A, B, C>(fa: (a: A) => B, fb: (b: B) => C): (a: A) => C;
export function pipe<A, B, C, D>(fa: (a: A) => B, fb: (b: B) => C, fc: (c: C) => D): (a: A) => D;
export function pipe<A, B, C, D, E>(fa: (a: A) => B, fb: (b: B) => C, fc: (c: C) => D, fd: (d: D) => E): (a: A) => E;
